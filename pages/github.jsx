...
const GithubPage = ({ repos, user, error }) => {
  ...
  return (
    <>
      <a href={`https://github.com/${user.login}`} target="_blank" rel="noopener" className={styles.no_color}>
...
export async function getStaticProps() {
  try {
    ...
    repos = repos
      .sort((a, b) => {
        if (a.html_url.includes('EESTech') || a.html_url.includes('COSC') || a.html_url.includes('/Murghendra/Murghendra')) {
          return -1;
        }
        if (b.html_url.includes('EESTech') || b.html_url.includes('COSC') || b.html_url.includes('/Murghendra/Murghendra')) {
          return 1;
        }
        return (
